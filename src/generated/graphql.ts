...
export type Excercise = Entity & Node & {
  ...
  /** Get the document in other stages */
  documentInStages: Array<Excercise>;
  /** List of Excercise versions */
  history: Array<Version>;
  /** The unique identifier */
  id: Scalars['ID']['output'];
...
export type ExcerciseCreatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type ExcerciseDocumentInStagesArgs = {
  includeCurrent?: Scalars['Boolean']['input'];
  inheritLocale?: Scalars['Boolean']['input'];
  stages?: Array<Stage>;
};
...
export type ExcerciseHistoryArgs = {
  limit?: Scalars['Int']['input'];
  skip?: Scalars['Int']['input'];
  stageOverride?: InputMaybe<Stage>;
};
...
export type ExcercisePublishedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
};


export type ExcerciseScheduledInArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
export type ExcerciseUpdatedByArgs = {
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
  locales?: InputMaybe<Array<Locale>>;
};

export type ExcerciseConnectInput = {
  /** Allow to specify document position in list of connected documents, will default to appending at end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Document to connect */
...
/** A connection to a list of items. */
export type ExcerciseConnection = {
  __typename?: 'ExcerciseConnection';
  aggregate: Aggregate;
  /** A list of edges. */
  edges: Array<ExcerciseEdge>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};

export type ExcerciseCreateInput = {
  clwyss1vl1tzj07w190rbae6d?: InputMaybe<WorkoutCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
...
export type ExcerciseCreateManyInlineInput = {
  /** Connect multiple existing Excercise documents */
  connect?: InputMaybe<Array<ExcerciseWhereUniqueInput>>;
  /** Create and connect multiple existing Excercise documents */
  create?: InputMaybe<Array<ExcerciseCreateInput>>;
};

export type ExcerciseCreateOneInlineInput = {
  /** Connect one existing Excercise document */
  connect?: InputMaybe<ExcerciseWhereUniqueInput>;
  /** Create and connect one Excercise document */
  create?: InputMaybe<ExcerciseCreateInput>;
};

/** An edge in a connection. */
export type ExcerciseEdge = {
  __typename?: 'ExcerciseEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: Excercise;
...
/** Identifies documents */
export type ExcerciseManyWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<ExcerciseWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<ExcerciseWhereInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<ExcerciseWhereInput>>;
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars['String']['input']>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  ...
  documentInStages_every?: InputMaybe<ExcerciseWhereStageInput>;
  documentInStages_none?: InputMaybe<ExcerciseWhereStageInput>;
  documentInStages_some?: InputMaybe<ExcerciseWhereStageInput>;
  id?: InputMaybe<Scalars['ID']['input']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']['input']>;
  /** All values ending with the given string. */
...
export enum ExcerciseOrderByInput {
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
...
export type ExcerciseUpdateInput = {
  clwyss1vl1tzj07w190rbae6d?: InputMaybe<WorkoutUpdateManyInlineInput>;
  description?: InputMaybe<Scalars['String']['input']>;
  name?: InputMaybe<Scalars['String']['input']>;
  video?: InputMaybe<Scalars['String']['input']>;
};

export type ExcerciseUpdateManyInlineInput = {
  /** Connect multiple existing Excercise documents */
  connect?: InputMaybe<Array<ExcerciseConnectInput>>;
  /** Create and connect multiple Excercise documents */
  create?: InputMaybe<Array<ExcerciseCreateInput>>;
  /** Delete multiple Excercise documents */
  delete?: InputMaybe<Array<ExcerciseWhereUniqueInput>>;
  /** Disconnect multiple Excercise documents */
  disconnect?: InputMaybe<Array<ExcerciseWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing Excercise documents */
  set?: InputMaybe<Array<ExcerciseWhereUniqueInput>>;
  /** Update multiple Excercise documents */
  update?: InputMaybe<Array<ExcerciseUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple Excercise documents */
  upsert?: InputMaybe<Array<ExcerciseUpsertWithNestedWhereUniqueInput>>;
};

export type ExcerciseUpdateManyInput = {
  description?: InputMaybe<Scalars['String']['input']>;
  name?: InputMaybe<Scalars['String']['input']>;
  video?: InputMaybe<Scalars['String']['input']>;
};

export type ExcerciseUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: ExcerciseUpdateManyInput;
  /** Document search */
  where: ExcerciseWhereInput;
};

export type ExcerciseUpdateOneInlineInput = {
  /** Connect existing Excercise document */
  connect?: InputMaybe<ExcerciseWhereUniqueInput>;
  /** Create and connect one Excercise document */
  create?: InputMaybe<ExcerciseCreateInput>;
  /** Delete currently connected Excercise document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Disconnect currently connected Excercise document */
  disconnect?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single Excercise document */
  update?: InputMaybe<ExcerciseUpdateWithNestedWhereUniqueInput>;
  /** Upsert single Excercise document */
  upsert?: InputMaybe<ExcerciseUpsertWithNestedWhereUniqueInput>;
};

export type ExcerciseUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
...
export type ExcerciseUpsertInput = {
  /** Create document if it didn't exist */
...
export type ExcerciseUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: ExcerciseUpsertInput;
  /** Unique document search */
  where: ExcerciseWhereUniqueInput;
};

/** This contains a set of filters that can be used to compare values internally */
export type ExcerciseWhereComparatorInput = {
  /** This field can be used to request to check if the entry is outdated by internal comparison */
  outdated_to?: InputMaybe<Scalars['Boolean']['input']>;
};

/** Identifies documents */
export type ExcerciseWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<ExcerciseWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<ExcerciseWhereInput>>;
...
/** The document in stages filter allows specifying a stage entry to cross compare the same document between different stages */
export type ExcerciseWhereStageInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<ExcerciseWhereStageInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<ExcerciseWhereStageInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<ExcerciseWhereStageInput>>;
  /** This field contains fields which can be set as true or false to specify an internal comparison */
  compareWithParent?: InputMaybe<ExcerciseWhereComparatorInput>;
  /** Specify the stage to compare with */
  stage?: InputMaybe<Stage>;
};

/** References Excercise record uniquely */
export type ExcerciseWhereUniqueInput = {
  id?: InputMaybe<Scalars['ID']['input']>;
};
...
export type Mutation = {
  ...
  /** Create one excercise */
  createExcercise?: Maybe<Excercise>;
  /** Create one program */
  ...
  /** Delete one excercise from _all_ existing stages. Returns deleted document. */
  deleteExcercise?: Maybe<Excercise>;
  /**
  ...
  /**
   * Delete many Excercise documents
   * @deprecated Please use the new paginated many mutation (deleteManyExcercisesConnection)
   */
  deleteManyExcercises: BatchPayload;
  /** Delete many Excercise documents, return deleted documents */
  deleteManyExcercisesConnection: ExcerciseConnection;
  /**
  ...
  /** Publish one excercise */
  publishExcercise?: Maybe<Excercise>;
  /**
  ...
  /**
   * Publish many Excercise documents
   * @deprecated Please use the new paginated many mutation (publishManyExcercisesConnection)
   */
  publishManyExcercises: BatchPayload;
  /** Publish many Excercise documents */
  publishManyExcercisesConnection: ExcerciseConnection;
  /**
  ...
  /** Schedule to publish one excercise */
  schedulePublishExcercise?: Maybe<Excercise>;
  ...
  /** Unpublish one excercise from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  scheduleUnpublishExcercise?: Maybe<Excercise>;
  ...
  /** Unpublish one excercise from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  unpublishExcercise?: Maybe<Excercise>;
  /**
  ...
  /**
   * Unpublish many Excercise documents
   * @deprecated Please use the new paginated many mutation (unpublishManyExcercisesConnection)
   */
  unpublishManyExcercises: BatchPayload;
  /** Find many Excercise documents that match criteria in specified stage and unpublish from target stages */
  unpublishManyExcercisesConnection: ExcerciseConnection;
  /**
  ...
  updateExcercise?: Maybe<Excercise>;
  /**
   * Update many assets
   ...
   * @deprecated Please use the new paginated many mutation (updateManyExcercisesConnection)
   */
  updateManyExcercises: BatchPayload;
  /** Update many Excercise documents */
  updateManyExcercisesConnection: ExcerciseConnection;
  /**
  ...
  /** Upsert one excercise */
  upsertExcercise?: Maybe<Excercise>;
  /** Upsert one program */
...
export type MutationCreateExcerciseArgs = {
  data: ExcerciseCreateInput;
};
...
export type MutationDeleteExcerciseArgs = {
  where: ExcerciseWhereUniqueInput;
};
...
export type MutationDeleteManyExcercisesArgs = {
  where?: InputMaybe<ExcerciseManyWhereInput>;
};


export type MutationDeleteManyExcercisesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type MutationPublishExcerciseArgs = {
  to?: Array<Stage>;
  where: ExcerciseWhereUniqueInput;
};
...
export type MutationPublishManyExcercisesArgs = {
  to?: Array<Stage>;
  where?: InputMaybe<ExcerciseManyWhereInput>;
};


export type MutationPublishManyExcercisesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  from?: InputMaybe<Stage>;
...
export type MutationSchedulePublishExcerciseArgs = {
  releaseAt?: InputMaybe<Scalars['DateTime']['input']>;
  releaseId?: InputMaybe<Scalars['String']['input']>;
  to?: Array<Stage>;
  where: ExcerciseWhereUniqueInput;
...
export type MutationScheduleUnpublishExcerciseArgs = {
  from?: Array<Stage>;
  releaseAt?: InputMaybe<Scalars['DateTime']['input']>;
  releaseId?: InputMaybe<Scalars['String']['input']>;
  where: ExcerciseWhereUniqueInput;
...
export type MutationUnpublishExcerciseArgs = {
  from?: Array<Stage>;
  where: ExcerciseWhereUniqueInput;
};
...
export type MutationUnpublishManyExcercisesArgs = {
  from?: Array<Stage>;
  where?: InputMaybe<ExcerciseManyWhereInput>;
};


export type MutationUnpublishManyExcercisesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  from?: Array<Stage>;
...
export type MutationUpdateExcerciseArgs = {
  data: ExcerciseUpdateInput;
  where: ExcerciseWhereUniqueInput;
};
...
export type MutationUpdateManyExcercisesArgs = {
  data: ExcerciseUpdateManyInput;
  where?: InputMaybe<ExcerciseManyWhereInput>;
};


export type MutationUpdateManyExcercisesConnectionArgs = {
  after?: InputMaybe<Scalars['ID']['input']>;
  before?: InputMaybe<Scalars['ID']['input']>;
  data: ExcerciseUpdateManyInput;
  first?: InputMaybe<Scalars['Int']['input']>;
...
export type MutationUpsertExcerciseArgs = {
  upsert: ExcerciseUpsertInput;
  where: ExcerciseWhereUniqueInput;
};
...
export type Query = {
  ...
  /** Retrieve a single excercise */
  excercise?: Maybe<Excercise>;
  /** Retrieve document version */
  excerciseVersion?: Maybe<DocumentVersion>;
  /** Retrieve multiple excercises */
  excercises: Array<Excercise>;
  /** Retrieve multiple excercises using the Relay connection interface */
  excercisesConnection: ExcerciseConnection;
  /** Fetches an object given its ID */
  node?: Maybe<Node>;
...
export type QueryExcerciseArgs = {
  locales?: Array<Locale>;
  stage?: Stage;
  where: ExcerciseWhereUniqueInput;
};
...
export type QueryExcerciseVersionArgs = {
  where: VersionWhereInput;
};


export type QueryExcercisesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  locales?: Array<Locale>;
  orderBy?: InputMaybe<ExcerciseOrderByInput>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  stage?: Stage;
  where?: InputMaybe<ExcerciseWhereInput>;
};


export type QueryExcercisesConnectionArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type ScheduledOperationAffectedDocument = Asset | Excercise | Program | Workout;
...
export type WorkoutExcercisesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
export type WorkoutCreateInput = {
  clwuebs0f0fi506wa0rmobc62?: InputMaybe<ProgramCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  description?: InputMaybe<Scalars['String']['input']>;
  excercises?: InputMaybe<ExcerciseCreateManyInlineInput>;
  image?: InputMaybe<AssetCreateOneInlineInput>;
  name?: InputMaybe<Scalars['String']['input']>;
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
};
...
export type WorkoutManyWhereInput = {
  ...
  excercises_every?: InputMaybe<ExcerciseWhereInput>;
  excercises_none?: InputMaybe<ExcerciseWhereInput>;
  excercises_some?: InputMaybe<ExcerciseWhereInput>;
  id?: InputMaybe<Scalars['ID']['input']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']['input']>;
  /** All values ending with the given string. */
...
export type WorkoutUpdateInput = {
  clwuebs0f0fi506wa0rmobc62?: InputMaybe<ProgramUpdateManyInlineInput>;
  description?: InputMaybe<Scalars['String']['input']>;
  excercises?: InputMaybe<ExcerciseUpdateManyInlineInput>;
  image?: InputMaybe<AssetUpdateOneInlineInput>;
  name?: InputMaybe<Scalars['String']['input']>;
};
...
export type GetExerciseQuery = { __typename?: 'Query', excercise?: { __typename?: 'Excercise', id: string, name?: string | null, description?: string | null, video?: string | null } | null };
...
export type GetProgramQuery = { __typename?: 'Query', program?: { __typename?: 'Program', id: string, name?: string | null, workouts: Array<{ __typename?: 'Workout', id: string, name?: string | null, description?: string | null, image?: { __typename?: 'Asset', url: string } | null }> } | null };

export type GetProgramsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProgramsQuery = { __typename?: 'Query', programs: Array<{ __typename?: 'Program', id: string, name?: string | null, description?: string | null, image?: { __typename?: 'Asset', url: string } | null }> };
